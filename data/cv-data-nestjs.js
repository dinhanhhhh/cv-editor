...
var cvData = {
    vi: {
        ...
        skills: [
            ...
            { cat: "Frameworks",     items: "NestJS, Express.js, Modular Architecture, Controller-Service Pattern" },
            { cat: "Database",        items: "MongoDB (Mongoose), MySQL, PostgreSQL, Query Optimization, Transactions" },
            { cat: "Security & API",  items: "RESTful API Design, JWT, RBAC, OAuth2, Guards/Middleware, Swagger/OpenAPI" },
            { cat: "DevOps & Tools",  items: "Git/GitHub, Docker, Postman, CI/CD basic, Vercel/Render" },
            { cat: "AI Coding Tools", items: "Gemini, Claude, GitHub Copilot — sử dụng AI hỗ trợ coding hàng ngày" }
        ],
        btnText: "In / Tải PDF",
    ...
    en: {
        ...
        skills: [
            ...
            { cat: "Security & API",   items: "RESTful API Design, JWT, RBAC, OAuth2, Guards/Middleware, Swagger/OpenAPI" },
            { cat: "DevOps & Tools",   items: "Git/GitHub, Docker, Postman, CI/CD basic, Vercel/Render" },
            { cat: "AI Coding Tools",  items: "Gemini, Claude, GitHub Copilot — daily AI-assisted development" }
        ],
