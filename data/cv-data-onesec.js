...
var cvData = {
  vi: {
    ...
    skills: [
      ...
      {
        cat: "Ngôn ngữ & Quản lý State",
        items:
          "JavaScript (ES6+), TypeScript, Redux / Redux Toolkit, Context API, React Hooks",
      },
      {
        cat: "Web & RESTful API",
        items:
          "ReactJS, Next.js, RESTful API Integration, JSON data processing, Postman",
      },
      {
        cat: "Cơ sở dữ liệu & Backend",
        items:
          "PostgreSQL, MongoDB, MySQL, Node.js (Express) cơ bản, .NET/C# (đã học và thực hành dự án)",
      },
      {
        cat: "Công cụ & Kiểm soát",
        items: "Git/GitHub, VS Code, Figma (đọc/xuất tài nguyên thiết kế)",
      },
      {
        cat: "Kỹ năng & Lợi thế",
        items:
          "Tư duy logic tốt, tự học công nghệ mới nhanh, có khả năng phát triển Backend .NET/C# cơ bản",
      },
    ],
    btnText: "In / Tải PDF",
...
GitHub: https://github.com/dinhanhhhh`,
  ...
  en: {
    ...
    skills: [
      ...
      {
        cat: "Languages & State Management",
        items:
          "JavaScript (ES6+), TypeScript, Redux / Redux Toolkit, Context API, React Hooks",
      },
      {
      ...
      },
      {
        ...
        items:
          "PostgreSQL, MongoDB, MySQL, basic Node.js (Express), .NET/C# (academic & project experience)",
      },
      {
        cat: "Tools & Design",
        items: "Git/GitHub, VS Code, Figma (asset extraction & inspection)",
      },
      {
        cat: "Key Strengths",
        items:
          "Logical thinking, rapid self-learning of new tech stacks, capable of basic .NET/C# development",
      },
    ],
