    ...
    skills: [
      {
        cat: "AI Tools",
        items:
          "Gemini, ChatGPT, GitHub Copilot, Prompt Engineering, AI-assisted development, LLM concepts",
      },
      {
        cat: "Frontend",
        items:
          "HTML5, CSS3, JavaScript (ES6+), React.js, Next.js, TypeScript, Tailwind CSS, Responsive Design",
      },
      {
        cat: "Backend",
        items: "Node.js, Express.js, RESTful API, JWT, RBAC, MongoDB, SQL",
      },
      {
        cat: "UI/UX",
        items:
          "Figma (view), Responsive layout, Mobile-first design, Accessibility cơ bản",
      },
      {
        cat: "Công cụ",
        items: "Git/GitHub, Vercel, Render, Postman, Swagger, VS Code, Docker",
      },
      {
        cat: "Ngoại ngữ",
        items:
          "Tiếng Anh: Đọc hiểu tài liệu kỹ thuật, giao tiếp công việc, viết báo cáo kỹ thuật cơ bản",
      },
    ],
    btnText: "In / Tải PDF",
  ...
  en: {
    ...
    skills: [
      ...
      },
      {
        cat: "UI/UX",
        items:
          "Figma (view), Responsive layout, Mobile-first design, Basic accessibility",
      },
      {
        cat: "Tools",
        items: "Git/GitHub, Vercel, Render, Postman, Swagger, VS Code, Docker",
      },
      {
        cat: "English",
        items:
          "Read technical docs, workplace communication, able to write basic technical reports",
      },
    ],
