...
const cvData = {
    vi: {
        ...
        title: "Agentic AI Engineer (Fresher)",
        contact: [
        ...
        objective: "Fresher với nền tảng Khoa học Máy tính và đam mê mạnh mẽ với AI, LLMs và Agentic AI. Có kinh nghiệm thực tế xây dựng hệ thống backend tự động hóa, tích hợp API và xử lý dữ liệu. Thành thạo Python và JavaScript, có khả năng tiếp thu nhanh các công nghệ mới như Generative AI, prompt engineering và các mô hình AI tiên tiến. Sẵn sàng làm việc full-time trong môi trường năng động và không ngừng học hỏi.",
        education: {
        ...
        skills: [
            { cat: "AI & LLM", items: "Generative AI, Prompt Engineering, LLM APIs (OpenAI, Gemini), Agentic AI concepts, AI-first mindset" },
            { cat: "Lập trình", items: "Python, JavaScript, TypeScript, Node.js, REST API integration, Data processing" },
            { cat: "Backend & Data", items: "Express.js, MongoDB, PostgreSQL, MySQL, API design, Automation scripting" },
            { cat: "Frontend", items: "React.js, Next.js, Tailwind CSS, Responsive Design" },
            { cat: "Công cụ", items: "Git/GitHub, Postman, Swagger, Docker, Vercel, VS Code" },
            { cat: "Ngoại ngữ", items: "Tiếng Anh: Đọc hiểu tài liệu kỹ thuật, giao tiếp công việc, có thể viết báo cáo kỹ thuật bằng tiếng Anh" }
        ],
        btnText: "In / Tải PDF",
        docTitle: "CV_TruongDinhAnh_AgenticAI_AgileOps"
    },
    ...
    en: {
        ...
        skills: [
            { cat: "AI & LLM", items: "Generative AI, Prompt Engineering, LLM APIs (OpenAI, Gemini), Agentic AI concepts, AI-first mindset" },
            { cat: "Programming", items: "Python, JavaScript, TypeScript, Node.js, REST API integration, Data processing" },
            { cat: "Backend & Data", items: "Express.js, MongoDB, PostgreSQL, MySQL, API design, Automation scripting" },
            { cat: "Frontend", items: "React.js, Next.js, Tailwind CSS, Responsive Design" },
            { cat: "Tools", items: "Git/GitHub, Postman, Swagger, Docker, Vercel, VS Code" },
            { cat: "English", items: "Read technical docs, workplace communication, able to write technical reports in English" }
        ],
