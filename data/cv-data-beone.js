...
var cvData = {
  vi: {
    ...
    skills: [
      {
        cat: "Nền tảng JS & Tư duy",
        items:
          "JavaScript/ES6+, Cấu trúc dữ liệu (Data Structures), Lập trình chức năng (Functional Programming), TypeScript",
      },
      {
        cat: "Frontend Stack",
        items: "React/Redux, Next.js, HTML5/CSS3, Responsive UI, Tailwind CSS",
      },
      {
        cat: "Backend Stack",
        items: "Node.js (Express), RESTful API Design, JWT, RBAC, Middleware",
      },
      {
        cat: "Cơ sở dữ liệu",
        items: "MongoDB (Mongoose), MySQL, Tối ưu hóa truy vấn",
      },
      {
        cat: "Công cụ & Kiểm soát",
        items:
          "Git/GitHub (Feature Branching), Docker, Swagger, Postman, Vercel, Render",
      },
      {
        cat: "Ngoại ngữ & Kỹ năng",
        items:
          "Tiếng Anh (đọc hiểu tài liệu kỹ thuật & giao tiếp tốt), Đam mê học hỏi, Giải quyết vấn đề",
      },
    ],
    btnText: "In / Tải PDF",
    ...
    skills: [
      {
        cat: "JS Foundations",
        items:
          "JavaScript/ES6+, Data Structures, Functional Programming, TypeScript",
      },
      {
        cat: "Frontend Stack",
        items: "React/Redux, Next.js, HTML5/CSS3, Responsive UI, Tailwind CSS",
      ...
      },
      {
        ...
        items:
          "English (reading technical docs & good communication), Passionate learner, Problem solving",
      },
    ],
