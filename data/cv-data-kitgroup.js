    ...
    skills: [
      {
        cat: "Frontend Stack",
        items:
          "Next.js (App Router), React.js, TypeScript, JavaScript (ES6+), Tailwind CSS, Responsive Design",
      },
      {
        cat: "Backend Stack",
        items:
          "Node.js (Express), RESTful API Design, JWT, RBAC, Middleware, MVC, NestJS (Đang tìm hiểu)",
      },
      {
        cat: "Cơ sở dữ liệu",
        items:
          "MySQL (Sequelize/Prisma), MongoDB (Mongoose), Thiết kế ERD, Tối ưu hóa truy vấn",
      },
      {
        cat: "Điện toán đám mây",
        items:
          "Tìm hiểu cơ bản về AWS (EC2, S3), triển khai ứng dụng thực tế trên Vercel & Render",
      },
      {
        cat: "Công cụ & DevOps",
        items:
          "Git/GitHub, Docker, Swagger (Tài liệu API), Postman, Vercel, Render",
      },
    ],
    btnText: "In / Tải PDF",
  ...
  en: {
    ...
    skills: [
      ...
      },
      {
        cat: "Backend Stack",
        items:
          "Node.js (Express), RESTful API Design, JWT, RBAC, Middleware, MVC, NestJS (Familiarity)",
      },
      {
        cat: "Databases",
        items:
          "MySQL (Sequelize/Prisma), MongoDB (Mongoose), ERD Design, Query Optimization",
      },
      {
        cat: "Cloud Services",
        items:
          "Basic knowledge of AWS (EC2, S3), practical deployment on Vercel & Render",
      },
      {
        cat: "Tools & DevOps",
        items:
          "Git/GitHub, Docker, Swagger (API Docs), Postman, Vercel, Render",
      },
    ],
