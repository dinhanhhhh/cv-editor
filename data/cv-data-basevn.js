...
var cvData = {
  vi: {
    ...
    skills: [
      {
        cat: "Cốt lõi & Thuật toán",
        items:
          "Cấu trúc dữ liệu & Giải thuật (Algorithms & Data Structures), Tư duy Product Ownership, User-Centric Design, Clean Code",
      },
      {
        cat: "Frontend Technologies",
        items:
          "HTML5, CSS3 (SASS/SCSS), Javascript/TypeScript, ReactJS, Next.js, jQuery, AJAX, Responsive Design",
      },
      {
        cat: "Backend & Database",
        items:
          "Node.js (Express), MySQL, MongoDB (Mongoose), RESTful API, JWT, JSON, Query Optimization",
      },
      {
        cat: "Công cụ phát triển",
        items:
          "Git / GitHub (Feature Branching), Postman, Swagger, Figma (view), Vercel, Docker basic",
      },
      {
        cat: "Ngoại ngữ & Kỹ năng",
        items:
          "Đọc hiểu tài liệu tiếng Anh tốt, tự quản lý công việc hiệu quả, tinh thần trách nhiệm cao đối với sản phẩm",
      },
    ],
    ...
    skills: [
      {
        cat: "Core & Algorithms",
        items:
          "Algorithms & Data Structures, Product Ownership Mindset, User-Centric Focus, Clean Code",
      },
      {
        cat: "Frontend Technologies",
        items:
      ...
      },
      {
        ...
        items:
          "Good English technical reading, self-driven learning, high product responsibility",
      },
    ],
    projectDisplayLimit: 2,
