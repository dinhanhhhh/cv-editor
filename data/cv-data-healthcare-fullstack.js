...
var cvData = {
  vi: {
    ...
    skills: [
      ...
      },
      {
        cat: "Backend",
        items:
          "Node.js, Express.js, NestJS (Learning), RESTful API, JWT, RBAC, Middleware",
      },
      {
        cat: "AI & Integration",
        items: "Tích hợp API AI (OpenAI, Gemini), Chatbot, Swagger, Postman",
      },
      {
        cat: "Cơ sở dữ liệu",
        items:
      ...
      {
        cat: "Quy trình",
        items: "Agile/Scrum, Code Review, Trello/Jira, Tư duy sản phẩm",
      },
    ],
    btnText: "In / Tải PDF",
  ...
  en: {
    ...
    skills: [
      ...
      {
        cat: "AI & Integration",
        items: "AI API Integration (OpenAI, Gemini), Chatbot, Swagger, Postman",
      },
      {
        cat: "Databases",
      ...
      {
        cat: "Process",
        items: "Agile/Scrum, Code Review, Trello/Jira, Product Mindset",
      },
    ],
