...
const cvData = {
  vi: {
    ...
    objective:
      "Lập trình viên Frontend chuyên React và Next.js, đã xây dựng và triển khai nhiều ứng dụng web thực tế. Có kinh nghiệm thiết kế giao diện, tích hợp API và tối ưu trải nghiệm người dùng. Luôn tập trung viết code rõ ràng, dễ bảo trì và sẵn sàng cho môi trường production.",
    projects: [
      {
  ...
  en: {
    ...
    objective:
      "Frontend Developer specializing in React and Next.js, with hands-on experience building and deploying real-world web applications. Proficient in UI design, API integration, and user experience optimization. Committed to writing clean, maintainable code for production environments.",
    projects: [
      {
