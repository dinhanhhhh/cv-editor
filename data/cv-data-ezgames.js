    ...
    skills: [
      {
        cat: "Front-End",
        items:
          "React.js, Next.js, HTML5, CSS3, JavaScript (ES6+), TypeScript, Tailwind CSS, Responsive Design",
      },
      {
        cat: "State & API",
        items:
      ...
      },
      {
        ...
        items:
          "Git, GitHub, VS Code, Postman (kiểm thử API), Figma (đọc/xuất tài nguyên thiết kế)",
      },
      {
        cat: "Kỹ năng mềm",
        items:
  ...
  en: {
    ...
    skills: [
      ...
      },
      {
        cat: "Bonus & DB",
        items:
          "PostgreSQL, Supabase (hands-on experience), MySQL, MongoDB, OOP, C#/.NET (ready to learn Unity)",
      },
      {
        cat: "Tools",
        items:
          "Git, GitHub, VS Code, Postman (API testing), Figma (extracting design assets)",
      },
      {
        cat: "Soft Skills",
        items:
